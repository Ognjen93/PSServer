            ...
            while (isActive) {
                ...
                if (request.startsWith(ProtocolMessages.UKLONI_IGRANJE.getMessage())) {
                    ...
                    if(igranje.length==6){
                        ...
                        out.println(ProtocolMessages.UKLONI_IGRANJE_OK.getMessage());
                    }
                    else{
                        out.println(ProtocolMessages.UKLONI_IGRANJE_NOT_OK.getMessage());
                    }
                }
                    ...
                    if(response!=null){
                        ...
                        out.println(ProtocolMessages.SCENE_NOT_OK.getMessage());
                    }
                }
                    ...
                    if(IgranjeDAO.getIgranja(Integer.parseInt(request.split(ProtocolMessages.MESSAGE_SEPARATOR.getMessage())[1]))!=null){
                        out.println(IgranjeDAO.getIgranja(Integer.parseInt(request.split(ProtocolMessages.MESSAGE_SEPARATOR.getMessage())[1])));
                    }
                    else {
                        out.println(ProtocolMessages.GET_IGRANJA_NOT_OK.getMessage());
                    }
                }
                    ...
                    out.println(ProtocolMessages.DODAJ_IGRANJE_OK.getMessage());
                }
                    ...
                    if(response!=null){
                        ...
                        out.println(ProtocolMessages.PREDSTAVE_NOT_OK.getMessage());
                    }
                }
                    ...
                    if(response!=null){
                        ...
                        out.println(ProtocolMessages.GOSTUJUCE_PREDSTAVE_NOT_OK.getMessage());
                    }
                }
                    ...
                    out.println(ProtocolMessages.AZURIRAJ_PREDSTAVU_OK.getMessage());
                }
                    ...
                    out.println(ProtocolMessages.DODAJ_AZURIRANJE_OK.getMessage());
                }
                    ...
                    out.println(ProtocolMessages.DODAJ_PREDSTAVU_OK.getMessage());
                }
                    ...
                    out.println(ProtocolMessages.DODAJ_KREIRANJE_OK.getMessage()+idP);
                }
                    ...
                    out.println(ProtocolMessages.DODAJ_GOSTUJUCU_PREDSTAVU_OK.getMessage());
                }
                    ...
                    out.println(ProtocolMessages.AZURIRAJ_GOSTUJUCU_PREDSTAVU_OK.getMessage());
                }
                    ...
                    out.println(ProtocolMessages.DODAJ_ADMINISTRATIVNOG_RADNIKA_OK.getMessage());
                }
                    ...
                    if(req.length==9) {
                        ...
                        out.println(ProtocolMessages.IZMIJENI_ADMINISTRATIVNOG_RADNIKA_OK.getMessage());
                    }
                    else{
                        out.println(ProtocolMessages.IZMIJENI_ADMINISTRATIVNOG_RADNIKA_NOT_OK.getMessage());
                    }
                }
                    ...
                    if(req.length==9){
                        ...
                        out.println(ProtocolMessages.DODAJ_BILETARA_OK.getMessage());
                    }
                    else{
                        out.println(ProtocolMessages.DODAJ_BILETARA_NOT_OK.getMessage());
                    }
                }
                    ...
                    if(req.length==9){
                        ...
                        out.println(ProtocolMessages.IZMIJENI_BILETARA_OK.getMessage());
                    }
                    else{
                        out.println(ProtocolMessages.IZMIJENI_BILETARA_NOT_OK.getMessage());
                    }
                }
...
//                  Umjetnik(String ime, String prezime, String jmb, boolean statusRadnika, String kontak, String biografija)
                    if(req.length==7){
                        ...
                        out.println(ProtocolMessages.DODAJ_UMJETNIKA_OK.getMessage());
                    }
                    else{
                        out.println(ProtocolMessages.DODAJ_UMJETNIKA_NOT_OK.getMessage());
                    }
                }
...
//                  Umjetnik(String ime, String prezime, String jmb, boolean statusRadnika, String kontak, String biografija)
                    if(req.length==8){
                        ...
                        out.println(ProtocolMessages.IZMIJENI_UMJETNIKA_OK.getMessage());
                    }
                    else{
                        out.println(ProtocolMessages.IZMIJENI_UMJETNIKA_NOT_OK.getMessage());
                    }
                }
...
//                  Repertoar(Integer id,Date mjesecIGodina)
                    if(req.length==3) {
                        ...
                        out.println(ProtocolMessages.DODAJ_REPERTOAR_OK.getMessage());
                    }
                    else {
                        out.println(ProtocolMessages.DODAJ_REPERTOAR_NOT_OK.getMessage());
                    }
                }
...
//                  Repertoar(Integer id,Date mjesecIGodina)
                    if(req.length==3) {
                        ...
                        out.println(ProtocolMessages.IZMIJENI_REPERTOAR_OK.getMessage());
                    }
                    else {
                        out.println(ProtocolMessages.IZMIJENI_REPERTOAR_NOT_OK.getMessage());
                    }
                }
                    ...
                    if(req.length==3) {
                        ...
                        out.println(ProtocolMessages.REZERVACIJE_NOT_OK.getMessage());
                    }
                }
                    ...
                    if(req.length==5){
                        ...
                        out.println(ProtocolMessages.ADD_REZERVACIJA_OK.getMessage());
                    }
                    else {
                        out.println(ProtocolMessages.ADD_REZERVACIJA_NOT_OK.getMessage());
                    }
                }
...
//                  RezervisanoSjediste(Integer idScene,Integer brojSjedista,Integer idRezervacije,Date termin)
                    if (req.length == 5) {
                        ...
                        out.println(ProtocolMessages.ADD_REZERVISANO_SJEDISTE_OK.getMessage());
                    }
                    else{
                        out.println(ProtocolMessages.ADD_REZERVISANO_SJEDISTE_NOT_OK.getMessage());
                    }
                }
...
//                  dodajAngazman(Integer idPredstave,Integer idUmjetnika,Integer idVrstaAngazmana,Date datumOd)
                    if(req.length==5){
                        ...
                        out.println(ProtocolMessages.DODAJ_ANGAZMAN_OK.getMessage());
                    }
                    else {
                        out.println(ProtocolMessages.DODAJ_ANGAZMAN_NOT_OK.getMessage());
                    }
                }
                    ...
                    if(req.length==6){
                        ...
                        out.println(ProtocolMessages.AZURIRAJ_ANGAZMAN_OK.getMessage());
                    }
                    else{
                        out.println(ProtocolMessages.AZURIRAJ_ANGAZMAN_NOT_OK.getMessage());
                    }
                }
                    ...
                    if(response!=null){
                        ...
                        out.println(ProtocolMessages.VRSTE_ANGAZMANA_NOT_OK.getMessage());
                    }
                }
                    ...
                    if(response!=null){
                        ...
                        out.println(ProtocolMessages.UMJETNICI_NOT_OK.getMessage());
                    }
                }
                    ...
                    if(req.length==4) {
                        ...
                        if (response != null) {
                            ...
                            out.println(ProtocolMessages.ANGAZMANI_NOT_OK.getMessage());
                        }
                    }
                    else {
                        out.println(ProtocolMessages.ANGAZMANI_NOT_OK.getMessage());
                    ...
                    if(req.length==2){
                        ...
                        out.println(ProtocolMessages.DODAJ_ANGAZMAN_VA_OK.getMessage());
                    }
                    else{
                        out.println(ProtocolMessages.DODAJ_ANGAZMAN_VA_NOT_OK.getMessage());
                    }
                }
                    ...
                    if(response!=null){
                        ...
                        out.println(ProtocolMessages.REPERTOARS_NOT_OK.getMessage());
                    }
                }
                    ...
                    if(response!=null){
                        ...
                        out.println(ProtocolMessages.KARTE_NOT_OK.getMessage());
                    }
                }
                    ...
                    if(req.length==2) {
                        ...
                        if(response!=null){
                            ...
                            out.println(ProtocolMessages.SJEDISTA_NOT_OK.getMessage());
                        }
                    }
                    else{
                        out.println(ProtocolMessages.SJEDISTA_NOT_OK.getMessage());
                    ...
                    if(req.length==5){
                        ...
                        out.println(ProtocolMessages.OBRISI_REZERVACIJU_OK.getMessage());
                    }
                    else {
                        out.println(ProtocolMessages.OBRISI_REZERVACIJU_NOT_OK.getMessage());
                    }
                }
                    ...
                    if(req.length==6){
                        ...
                        out.println(ProtocolMessages.DODAJ_KARTU_OK.getMessage());
                    }
                    else {
                        out.println(ProtocolMessages.DODAJ_KARTU_NOT_OK.getMessage());
                    }
                }
                    ...
                    if(req.length==2){
                        ...
                        out.println(ProtocolMessages.OBRISI_KARTU_OK.getMessage());
                    }
                    else{
                        out.println(ProtocolMessages.OBRISI_KARTU_NOT_OK.getMessage());
                    }
                }
                    ...
                    if(req.length==5){
                        ...
                        out.println(ProtocolMessages.OBRISI_REZERVISANO_SJEDISTE_OK.getMessage());
                    }
                    else{
                        out.println(ProtocolMessages.OBRISI_REZERVISANO_SJEDISTE_NOT_OK.getMessage());
                    }
                }
                    ...
                    if(req.length==3){
                        ...
                        out.println(ProtocolMessages.SJEDISTA_RS_NOT_OK.getMessage());
                    }
                }
                    ...
                    if(req.length==2){
                        if(AdministratorDAO.provjeriMaticniBrojUBazi(req[1])==false){
                            out.println(ProtocolMessages.PROVJERI_MATICNI_BROJ_U_BAZI_RESPONSE.getMessage()+"false");
                        }
                        else {
                            out.println(ProtocolMessages.PROVJERI_MATICNI_BROJ_U_BAZI_RESPONSE.getMessage()+"true");
                        }
                    }
                    else {
                        out.print(ProtocolMessages.PROVJERI_MATICNI_BROJ_U_BAZI_NOT_OK.getMessage());
                    }
                }
                    ...
                    if(req.length==2){
                        if(AdministratorDAO.postojiUBaziLozinka(req[1])==true){
                            out.println(ProtocolMessages.POSOTOJI_U_BAZI_LOZINKA_RESPONSE.getMessage()+"true");
                        }
                        else {
                            out.println(ProtocolMessages.POSOTOJI_U_BAZI_LOZINKA_RESPONSE.getMessage()+"false");
                        }
                    }
                    else {
                        out.print(ProtocolMessages.POSOTOJI_U_BAZI_LOZINKA_NOT_OK.getMessage());
                    }
                }
                    ...
                    if(req.length==2){
                        if(AdministratorDAO.postojiUBaziKorisnickoIme(req[1])==true){
                            out.println(ProtocolMessages.POSTOJI_U_BAZI_KORISNICKO_IME_RESPONSE.getMessage()+"true");
                        }
                        else {
                            out.println(ProtocolMessages.POSTOJI_U_BAZI_KORISNICKO_IME_RESPONSE.getMessage()+"false");
                        }
                    }
                    else {
                        out.print(ProtocolMessages.POSTOJI_U_BAZI_KORISNICKO_IME_NOT_OK.getMessage());
                    }
                }
...
//                        dodavanjeSjedista(Integer idScene,Integer brojSjedista)
                        if(SjedisteDAO.dodavanjeSjedista(Integer.parseInt(req[1]), Integer.parseInt(req[2]))){
                            out.println(ProtocolMessages.DODAVANJE_SJEDISTA_OK.getMessage());
                        }
                        else {
                            out.println(ProtocolMessages.DODAVANJE_SJEDISTA_NOT_OK.getMessage());
                        }
                    }
                    else {
                        out.println(ProtocolMessages.DODAVANJE_SJEDISTA_NOT_OK.getMessage());
